 ...
 *
 */
package org.openmrs.module.pharmacyapi.api.common.exception;
...
public class PharmacyBusinessException extends Exception {
	 ...
	 * should be given to the {@link #PharmacyBusinessException(String, Throwable)} constructor if
	 * at all possible instead of this one.
	 * 
	 * @param cause the parent exception cause that this APIException is wrapping around
	 */
	public PharmacyBusinessException(final Throwable cause) {
		super(cause);
	}
	 ...
	 */
	public PharmacyBusinessException(final String messageKey, final Object... parameters) {
	 ...
	 * @param cause the parent exception cause that this APIException is wrapping around
	 */
	public PharmacyBusinessException(final String messageKey, final Throwable cause, final Object... parameters) {
