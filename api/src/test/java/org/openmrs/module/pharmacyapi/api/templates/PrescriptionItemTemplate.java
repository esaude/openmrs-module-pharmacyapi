...
public class PrescriptionItemTemplate implements TemplateLoader {
	...
	public static final String VALID_ARV_ITEM_01 = "VALID_ARV_ITEM_01";
	
	@Override
	public void load() {
		
		Fixture.of(PrescriptionItem.class).addTemplate(PrescriptionItemTemplate.VALID_01, new Rule() {
		...
		Fixture.of(PrescriptionItem.class).addTemplate(PrescriptionItemTemplate.VALID_ARV_ITEM_01, new Rule() {
			
			{
				this.add("drugOrder", this.one(DrugOrder.class, DrugOrderTemplate.VALID_ARV_01));
