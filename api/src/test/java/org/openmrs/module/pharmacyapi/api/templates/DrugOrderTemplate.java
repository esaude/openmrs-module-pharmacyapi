...
public class DrugOrderTemplate implements TemplateLoader {
	...
	public static final String VALID_PROFLAXIA_TRIOMUNE30 = "VALID_PROFLAXIA_TRIOMUNE30";
	
	public static final String VALID_PROFLAXIA_ASPIRIN = "VALID_PROFLAXIA_ASPIRIN";
	
	public static final String VALID_ARV_NEVIRAPINA = "VALID_ARV_NEVIRAPINA";
	
	@Override
	public void load() {
		
		Fixture.of(DrugOrder.class).addTemplate(DrugOrderTemplate.VALID_PROFLAXIA_TRIOMUNE30, new Rule() {
		...
		Fixture.of(DrugOrder.class).addTemplate(DrugOrderTemplate.VALID_PROFLAXIA_ASPIRIN, new Rule() {
			
			{
				this.add("dateCreated", this.instant("now"));
				this.add("drug", this.one(Drug.class, DrugTemplate.ASPIRIN));
				this.add("dose", new Double(2));
				this.add("doseUnits", this.one(Concept.class, ConceptTemplate.MG_DOSE_UNITS));
				this.add("frequency", this.one(OrderFrequency.class, OrderFrequencyTemplate.FREQUENCY_ONCE_A_DAY));
				this.add("quantityUnits", this.one(Concept.class, ConceptTemplate.TABS_QUANTITY_UNITS));
		...
		Fixture.of(DrugOrder.class).addTemplate(DrugOrderTemplate.VALID_ARV_NEVIRAPINA, new Rule() {
			
			{
				this.add("dateCreated", this.instant("now"));
				this.add("drug", this.one(Drug.class, DrugTemplate.NEVIRAPINA));
				this.add("dose", new Double(2));
				this.add("doseUnits", this.one(Concept.class, ConceptTemplate.MG_DOSE_UNITS));
				this.add("frequency", this.one(OrderFrequency.class, OrderFrequencyTemplate.FREQUENCY_ONCE_A_DAY));
				this.add("quantityUnits", this.one(Concept.class, ConceptTemplate.TABS_QUANTITY_UNITS));
