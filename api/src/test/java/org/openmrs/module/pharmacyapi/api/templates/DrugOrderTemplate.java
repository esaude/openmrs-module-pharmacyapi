...
public class DrugOrderTemplate implements TemplateLoader {
	...
	public static final String VALID_ARV_01 = "VALID_ARV_01";
	
	@Override
	public void load() {
		
		Fixture.of(DrugOrder.class).addTemplate(DrugOrderTemplate.VALID_PROFLAXIA_01, new Rule() {
		...
		Fixture.of(DrugOrder.class).addTemplate(DrugOrderTemplate.VALID_ARV_01, new Rule() {
